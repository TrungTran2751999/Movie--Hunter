        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="/admin/movie?action=edit" enctype="multipart/form-data" method="post" style="display: flex; flex-direction: column; gap: 10px">
              ...
              <div>
                <div>IMAGE</div>
                <img  style="margin-bottom: 12px" src="${pageContext.request.contextPath}/admin/upload-admin/${image}" width="100px" height="150px">
                <input id="image" type="file" name="image" class="form-control">
              </div>
              <div>
                <label>LINK</label>
                <input type="text" name="link" value="${movie.getLink()}" class="form-control" required>
              </div>
